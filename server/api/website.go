...
//WebsiteTitle 网站标题栏
func (websitr *WebsiteApi) WebsiteTitle(c *gin.Context) {
...
func (webiste *WebsiteApi) WebsiteFooterLink(c *gin.Context) {
...
func (website *WebsiteApi) WebsiteCancelCarousel(c *gin.Context) {
	...
	if err != nil {
		global.Log.Error("Failed to calcel carousel:", zap.Error(err))
...
func (website *WebsiteApi) WebsiteDeleteFooterLink(c *gin.Context) {
	...
	response.OkWithMessage("Successfully delete footer link", c)
}